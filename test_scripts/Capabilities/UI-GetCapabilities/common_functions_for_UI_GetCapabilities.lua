...
-----------------------------------------------------------------------------
-- Do InitHMI_onReady without UI.GetCapabilities
-----------------------------------------------------------------------------
function commonFunctionsForUIGetCapabilities:InitHMI_onReady_without_UI_GetCapabilities(self)
...
return commonFunctionsForUIGetCapabilities
