...
-- Description:
-- SDL will use default capabilities stored at hmi_capabilities.json file when value hmiZoneCapabilities is miss

-- Preconditions:
-- 1. HMI -> SDL: value of hmiZoneCapabilities in UI.GetCapabilities is miss
...
function Test:Preconditions_InitHMI_OnReady()
  ...
  :Do(function(_,data)
      send_hmi_capabilities.hmiZoneCapabilities = nil
