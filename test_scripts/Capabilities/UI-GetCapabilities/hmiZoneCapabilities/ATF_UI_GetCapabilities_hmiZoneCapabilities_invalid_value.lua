...
-- Description:
-- SDL will use default capabilities stored at hmi_capabilities.json file when value hmiZoneCapabilities is invalid value

-- Preconditions:
-- 1. HMI -> SDL: value of hmiZoneCapabilities in UI.GetCapabilities is invalid value
...
function Test:Preconditions_InitHMI_OnReady()
  ...
  :Do(function(_,data)
      send_hmi_capabilities.hmiZoneCapabilities = "ABCD"
