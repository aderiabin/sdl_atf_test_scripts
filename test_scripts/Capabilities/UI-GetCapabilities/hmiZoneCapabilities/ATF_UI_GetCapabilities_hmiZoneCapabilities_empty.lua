...
-- Description:
-- SDL will use default capabilities stored at hmi_capabilities.json file when value hmiZoneCapabilities is empty

-- Preconditions:
-- 1. HMI -> SDL: value of hmiZoneCapabilities in UI.GetCapabilities is empty
...
function Test:Preconditions_InitHMI_OnReady()
  ...
  :Do(function(_,data)
      send_hmi_capabilities.hmiZoneCapabilities = ""
