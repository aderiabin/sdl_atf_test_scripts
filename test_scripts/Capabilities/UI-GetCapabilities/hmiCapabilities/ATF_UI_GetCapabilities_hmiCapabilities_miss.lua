...
-- Description:
-- SDL will use default hmiCapabilities when value hmiCapabilities is miss

-- Preconditions:
-- 1. HMI -> SDL: miss value of hmiCapabilities in UI.GetCapabilities
...
function Test:Preconditions_InitHMI_OnReady()
  ...
  :Do(function(_,data)
      send_hmi_capabilities.hmiCapabilities = nil
