...
-- Description:
-- SDL will use default hmiCapabilities when value hmiCapabilities is invalid type

-- Preconditions:
-- 1. HMI -> SDL: value of hmiCapabilities in UI.GetCapabilities is invalid
...
function Test:Preconditions_InitHMI_OnReady()
  ...
  :Do(function(_,data)
      send_hmi_capabilities.hmiCapabilities = 123
