...
-- Description:
-- SDL will use default value of phoneCall when value hmiCapabilities.phoneCall is miss

-- Preconditions:
-- 1. HMI -> SDL: miss value of hmiCapabilities.phoneCall in UI.GetCapabilities
...
function Test:Preconditions_InitHMI_OnReady()
  ...
  :Do(function(_,data)
      send_hmi_capabilities.hmiCapabilities.phoneCall = nil
