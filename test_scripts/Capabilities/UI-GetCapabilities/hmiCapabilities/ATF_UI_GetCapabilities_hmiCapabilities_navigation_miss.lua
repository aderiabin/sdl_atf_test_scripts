...
-- Description:
-- SDL will use default value of navigation when value hmiCapabilities.navigation is miss

-- Preconditions:
-- 1. HMI -> SDL: miss value of hmiCapabilities.navigation in UI.GetCapabilities
...
function Test:Preconditions_InitHMI_OnReady()
  ...
  :Do(function(_,data)
      send_hmi_capabilities.hmiCapabilities.navigation = nil
