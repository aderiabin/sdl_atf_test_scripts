...
-- Description:
-- SDL will use default capabilities stored at hmi_capabilities.json file when value softButtonCapabilities is invalid type

-- Preconditions:
-- 1. HMI -> SDL: invalid type of softButtonCapabilities in UI.GetCapabilities
...
function Test:Preconditions_InitHMI_OnReady()
  ...
  local send_softButtonCapabilities = 123
