...
-- Description:
-- SDL will use default capabilities stored at hmi_capabilities.json file when value softButtonCapabilities.shortPressAvailable is invalid

-- Preconditions:
-- 1. HMI -> SDL: invalid value of softButtonCapabilities.shortPressAvailable in UI.GetCapabilities
