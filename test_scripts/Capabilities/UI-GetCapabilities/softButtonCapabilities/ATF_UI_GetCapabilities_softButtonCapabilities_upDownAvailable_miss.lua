...
-- Description:
-- SDL will use default capabilities stored at hmi_capabilities.json file when value softButtonCapabilities.upDownAvailable is missed

-- Preconditions:
-- 1. HMI -> SDL: value of softButtonCapabilities.upDownAvailable in UI.GetCapabilities is missed
