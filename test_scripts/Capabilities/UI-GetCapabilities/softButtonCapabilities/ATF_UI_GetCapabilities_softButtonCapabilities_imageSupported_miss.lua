...
-- Description:
-- SDL will use default capabilities stored at hmi_capabilities.json file when value softButtonCapabilities.imageSupported is missed

-- Preconditions:
-- 1. HMI -> SDL: value of softButtonCapabilities.imageSupported in UI.GetCapabilities is missed
