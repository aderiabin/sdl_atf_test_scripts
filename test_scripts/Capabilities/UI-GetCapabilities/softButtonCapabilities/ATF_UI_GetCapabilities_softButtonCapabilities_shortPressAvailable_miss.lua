...
-- Description:
-- SDL will use default capabilities stored at hmi_capabilities.json file when value softButtonCapabilities.shortPressAvailable is missed

-- Preconditions:
-- 1. HMI -> SDL: value of softButtonCapabilities.shortPressAvailable in UI.GetCapabilities is missed

-- Steps:
-- 1. Register App

-- Expected result:
-- SDL -> Mob: value softButtonCapabilities.shortPressAvailable from hmi_capabilities.json file
---------------------------------------------------------------------------------------------
