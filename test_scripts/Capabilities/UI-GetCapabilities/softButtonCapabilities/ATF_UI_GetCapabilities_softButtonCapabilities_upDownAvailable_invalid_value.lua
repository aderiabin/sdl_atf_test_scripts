...
-- Description:
-- SDL will use default capabilities stored at hmi_capabilities.json file when value softButtonCapabilities.upDownAvailable is invalid

-- Preconditions:
-- 1. HMI -> SDL: invalid value of softButtonCapabilities.upDownAvailable in UI.GetCapabilities
