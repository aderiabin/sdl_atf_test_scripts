...
-- Description:
-- SDL will send value TRUE of UI.GetCapabilities.softButtonCapabilities from HMI to mobile

-- Preconditions:
-- 1. HMI -> SDL: value TRUE of UI.GetCapabilities.softButtonCapabilities

-- Steps:
-- 1. Register App

-- Expected result:
-- SDL -> Mob: value TRUE of UI.GetCapabilities.softButtonCapabilities
---------------------------------------------------------------------------------------------
