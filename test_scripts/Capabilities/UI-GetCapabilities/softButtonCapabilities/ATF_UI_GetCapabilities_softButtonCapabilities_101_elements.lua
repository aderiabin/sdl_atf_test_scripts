...
-- Description:
-- SDL will use default capabilities stored at hmi_capabilities.json file when softButtonCapabilities contains 101 elements

-- Preconditions:
-- 1. HMI -> SDL: value of softButtonCapabilities in UI.GetCapabilities contains 101 elements
