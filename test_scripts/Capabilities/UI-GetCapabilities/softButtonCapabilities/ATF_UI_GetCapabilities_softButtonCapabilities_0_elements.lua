...
-- Description:
-- SDL will use default capabilities stored at hmi_capabilities.json file when softButtonCapabilities contains 0 elements

-- Preconditions:
-- 1. HMI -> SDL: value of softButtonCapabilities in UI.GetCapabilities contains 0 elements

-- Steps:
-- 1. Register App

-- Expected result:
-- SDL -> Mob: value softButtonCapabilities from hmi_capabilities.json file
---------------------------------------------------------------------------------------------
...
function Test:Preconditions_InitHMI_OnReady()
  ...
  :Do(function(_,data)
      send_hmi_capabilities.softButtonCapabilities = {}
