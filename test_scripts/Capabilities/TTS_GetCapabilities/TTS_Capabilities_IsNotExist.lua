...
local function MobileRegisterAppAndVerifyTTSCapabilities(self)
  ...
  EXPECT_RESPONSE(correlationId, { success = true, speechCapabilities = speechCapabilities_Default,prerecordedSpeech = prerecordedSpeech})
  :Do(function(_,data)
    end)
end
---------------------------------------- Steps ---------------------------------------
local function verifyTTSCapabilitiesWhenSpeechCapabilitiesNotExist()
  common_steps:AddNewTestCasesGroup("Test case: HMI sends TTS.GetCapabilities with speechCapabilities does not exist")
  common_steps:StartSDL("Precondition_StartSDL")
  common_steps:InitializeHmi("Precondition_InitHMI")

  Test["Verify_HMI_Send_TTS_Capabilities_With_SpeechCapabilities_NotExist"] = function(self)
...
local function verifyTTSCapabilitiesWhenPrerecordSpeechCapabilitiesNotExist()
  common_steps:AddNewTestCasesGroup("Test case: HMI sends TTS.GetCapabilities with prerecordedSpeechCapabilities does not exist")
  common_steps:StartSDL("Precondition_StartSDL")
  common_steps:InitializeHmi("Precondition_InitHMI")

  Test["Verify_HMI_Send_TTS_Capabilities_With_PrerecordspeechCapabilities_NotExist"] = function(self)
...
local function verifyTTSCapabilitiesWhenSpeechCapabilitiesAndPrerecordSpeechCapabilitiesNotExist()
  common_steps:AddNewTestCasesGroup("Test case: HMI sends TTS.GetCapabilities with speechCapabilities and prerecordedSpeechCapabilities do not exist")
  common_steps:StartSDL("Precondition_StartSDL")
  common_steps:InitializeHmi("Precondition_InitHMI")

  Test["Verify_HMI_Send_TTS_Capabilities_With_SpeechCapabilities_And_PrerecordspeechCapabilities_NotExist"] = function(self)
