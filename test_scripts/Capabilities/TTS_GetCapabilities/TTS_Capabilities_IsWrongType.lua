...
local function verifyTTSCapabilitiesWhenSpeechCapabilitiesWrongType()
  common_steps:AddNewTestCasesGroup("Test case: HMI sends TTS.GetCapabilities with speechCapabilities has wrong type")
...
local function verifyTTSCapabilitiesWhenPrerecordSpeechCapabilitiesWrongType()
  common_steps:AddNewTestCasesGroup("Test case: HMI sends TTS.GetCapabilities with prerecordedSpeechCapabilities has wrong type")
  common_steps:StartSDL("Precondition_StartSDL")
  common_steps:InitializeHmi("Precondition_InitHMI")
