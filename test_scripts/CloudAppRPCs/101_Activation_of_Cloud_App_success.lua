...
--  2) HMI is started and receives information about enabled cloud application (Application with hmiAppId_1 represents cloudApp_1 on HMI )
  ...
  :ValidIf(function(_, data)
      for _, app in ipairs(data.params.applications) do
        if app.appID == cloudAppHmiId then
          ...
          return false, "cloudConnectionStatus of app: " .. app.appID .. " Expected: CONNECTED, Actual: " .. app.cloudConnectionStatus
        end
      end
...
runner.Step("Start cloud application server", common.mobile.createConnection, {1, cloudServerParams.host, cloudServerParams.port, "CLOUD"})
