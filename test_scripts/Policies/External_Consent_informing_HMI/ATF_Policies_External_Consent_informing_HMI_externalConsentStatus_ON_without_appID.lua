...
--------------------------------------------------------------------------
-- Test-02.01:  
-- Description: HMI provides <externalConsentStatus> to SDL with status = ON. HMI -> SDL: GetListOfPermissions without appID
...
Test[TEST_NAME .. "externalConsentStatus_ON_And_GetListOfPermissions_without_appID"] = function(self)
  ...
  :ValidIf(function(_,data)
    ...
    common_functions_external_consent_informing_hmi:Validate_externalConsentStatus_EntityType_EntityId(data, 0, 0) and
