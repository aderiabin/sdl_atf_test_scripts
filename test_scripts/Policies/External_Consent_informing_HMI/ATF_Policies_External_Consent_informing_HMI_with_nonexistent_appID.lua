...
--------------------------------------------------------------------------
-- Test-06.01:  
-- Description: HMI does NOT provide <externalConsentStatus> to SDL. HMI -> SDL: GetListOfPermissions with appID of nonexistent app
-- Expected Result:
...
--   externalConsentStatus: display all externalConsentStatus which is sent by OnAppPermissionConsent from HMI
--------------------------------------------------------------------------
-- Precondition:
...
Test[TEST_NAME.."MainCheck_GetListOfPermissions_with_nonexistent_appID"] = function(self)
  ...
  :ValidIf(function(_,data)
    ...
    common_functions_external_consent_informing_hmi:Validate_externalConsentStatus_EntityType_EntityId(data, 2, 2) and
    common_functions_external_consent_informing_hmi:Validate_externalConsentStatus_EntityType_EntityId(data, 3, 3) 
  end)       
end
