...
----------------------------------------------------
-- Test-03.02:  
-- Description: HMI provides <externalConsentStatus> to SDL with status = OFF. HMI -> SDL: GetListOfPermissions with appID
...
--------------------------------------------------------------------------    
Test[TEST_NAME .. "MainCheck_externalConsentStatus_OFF_And_GetListOfPermissions_with_appID"] = function(self)
  ...
  :ValidIf(function(_,data)
    ...
    common_functions_external_consent_informing_hmi:Validate_externalConsentStatus_EntityType_EntityId(data, 127, 127) and
