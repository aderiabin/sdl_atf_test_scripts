...
----------------------------------------------------
-- Test-01.02:  
-- Description: HMI does NOT provide <externalConsentStatus> to SDL. HMI -> SDL: GetListOfPermissions with appID
-- Expected result:
...
--------------------------------------------------------------------------
Test[TEST_NAME.."MainCheck_1_externalConsentStatus_EMPTY_And_GetListOfPermissions_with_appID"] = function(self)
  ...
  :ValidIf(function(_,data)
    return common_functions_external_consent_informing_hmi:Validate_AllowedFunctions_Id(data, "ConsentGroup001")
  end)
  :Do(function(_,data)
...
--------------------------------------------------------------------------
-- Precondition:
--   HMI sends OnAppPermissionConsent externalConsentStatus array is empty
--------------------------------------------------------------------------
...
--   Check GetListOfPermissions response with empty externalConsentStatus array list
--------------------------------------------------------------------------
Test[TEST_NAME.."MainCheck_2_externalConsentStatus_EMPTY_And_GetListOfPermissions_with_appID"] = function(self)
  --hmi side: sending SDL.GetListOfPermissions request to SDL
  local request_id = self.hmiConnection:SendRequest("SDL.GetListOfPermissions", {appID = hmi_app_id_1}) 
  -- hmi side: expect SDL.GetListOfPermissions response
  EXPECT_HMIRESPONSE(request_id,{
