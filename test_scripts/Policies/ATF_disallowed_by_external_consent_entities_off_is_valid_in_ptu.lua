...
for i=1, #valid_entity_type_cases do
  for j=1, #valid_entity_id_cases do
    ...
    local test_case_name = test_case_id .. "_disallowed_by_external_consent_entities_off.entityType_" .. valid_entity_type_cases[i].description .."_".. valid_entity_id_cases[j].description
