...
--------------------------------------------------------------------------
-- Test 01.02:
-- Description: disallowed_by_ccs_entities_on/off is omitted. HMI -> SDL: OnAppPermissionConsent(ccsStatus OFF, function disallowed)
...
--------------------------------------------------------------------------
-- Precondition:
-- HMI sends OnAppPermissionConsent with ccs status = OFF and consented function = disallowed
--------------------------------------------------------------------------
