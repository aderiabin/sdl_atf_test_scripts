...
--------------------------------------------------------------------------
-- Test 04.02:
-- Description: disallowed_by_ccs_entities_on exists. HMI -> SDL: OnAppPermissionConsent(ccsStatus OFF, function disallowed)
...
--------------------------------------------------------------------------
-- Precondition:
-- HMI sends OnAppPermissionConsent with consented function = disallowed and ccs status = OFF
--------------------------------------------------------------------------
