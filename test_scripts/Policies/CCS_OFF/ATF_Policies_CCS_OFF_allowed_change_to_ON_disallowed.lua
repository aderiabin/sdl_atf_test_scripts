...
-- HMI -> SDL: OnAppPermissionConsent(ccsStatus ON)
-- Expected Result:
...
-- when HMI sends OnAppPermissionConsent with ccs status = ON
--------------------------------------------------------------------------
Test[TEST_NAME_OFF .. "MainCheck_HMI_sends_OnAppPermissionConsent_ccsStatus_ON"] = function(self)
...
--------------------------------------------------------------------------
-- Main check:
-- Check consent_group in Policy Table: is_consented = 0 (updated)
--------------------------------------------------------------------------
...
--------------------------------------------------------------------------
-- Main check:
-- Check ccs_consent_group in Policy Table: is_consented = 0 (updated)
--------------------------------------------------------------------------
