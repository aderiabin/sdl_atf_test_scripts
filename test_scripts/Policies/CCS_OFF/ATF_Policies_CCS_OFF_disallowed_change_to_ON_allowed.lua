...
-- TEST 08:
-- In case
-- SDL gets SDL.OnAppPermissionConsent with ccsStatus change from "OFF" to "ON"
...
-- (disallowed_by_ccs_entities_off exists. HMI -> SDL: OnAppPermissionConsent(ccsStatus OFF))
