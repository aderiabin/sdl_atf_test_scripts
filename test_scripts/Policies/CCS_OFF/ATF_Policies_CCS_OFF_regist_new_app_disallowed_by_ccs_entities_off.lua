...
--------------------------------------------------------------------------
-- Test 12.02:
-- Description: disallowed_by_ccs_entities_off. HMI -> SDL: OnAppPermissionConsent(ccsStatus OFF). Register new applications.
...
--------------------------------------------------------------------------
Test[TEST_NAME_OFF .. "MainCheck_RPC_of_Application_3_Group001_is_allowed"] = function(self)
