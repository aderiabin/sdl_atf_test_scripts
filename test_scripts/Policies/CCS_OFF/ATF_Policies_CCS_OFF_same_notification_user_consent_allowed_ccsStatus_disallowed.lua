...
--------------------------------------------------------------------------
-- Test 04.01:
-- Description: disallowed_by_ccs_entities_off exists. HMI -> SDL: OnAppPermissionConsent(ccsStatus OFF, function allowed)
...
--------------------------------------------------------------------------
-- Precondition:
-- HMI sends OnAppPermissionConsent with consented function = allowed and ccs status = OFF
--------------------------------------------------------------------------
