...
--------------------------------------------------------------------------
-- Test 01.04:
-- Description: disallowed_by_ccs_entities_on/off is omitted. Data consent is disallowed. HMI -> SDL: OnAppPermissionConsent(ccsStatus OFF, function allowed)
...
--------------------------------------------------------------------------
Test[TEST_NAME_OFF .. "MainCheck_Check_Device_Consent_Group"] = function(self)
