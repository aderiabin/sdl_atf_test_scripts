...
-- HMI -> SDL: OnAppPermissionConsent(ccsStatus OFF) with entities pair only match one entities pair in group.
...
Test[TEST_NAME_OFF .. "Precondition_HMI_sends_OnAppPermissionConsent"] = function(self)
  ...
  :ValidIf(function(_,data)
      local validate_result_1 = common_functions_ccs_off:ValidateHMIPermissions(data,
      ...
      local validate_result_3 = common_functions_ccs_off:ValidateHMIPermissions(data,
...
--------------------------------------------------------------------------
Test[TEST_NAME_OFF .. "MainCheck_Check_Ccs_Consent_Group_of_Group003"] = function(self)
...
--------------------------------------------------------------------------
Test[TEST_NAME_OFF .. "MainCheck_Check_Ccs_Consent_Group_of_Group004"] = function(self)
...
--------------------------------------------------------------------------
Test[TEST_NAME_OFF .. "MainCheck_Check_Ccs_Consent_Group_of_Group005"] = function(self)
...
--------------------------------------------------------------------------
Test[TEST_NAME_OFF .. "MainCheck_Check_Consent_Group_of_Group003"] = function(self)
...
--------------------------------------------------------------------------
Test[TEST_NAME_OFF .. "MainCheck_Check_Consent_Group_of_Group004"] = function(self)
...
--------------------------------------------------------------------------
Test[TEST_NAME_OFF .. "MainCheck_Check_Consent_Group_of_Group005"] = function(self)
