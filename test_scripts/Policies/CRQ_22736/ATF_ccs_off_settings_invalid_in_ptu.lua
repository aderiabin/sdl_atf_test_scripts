...
local function VerifyPTUFailedWithInvalidCcsOn(test_case_name, ptu_file)
	Test["VerifyPTUFailedWithInvalidCcsOn"] = function (self)
...
------------------------------------------- BODY ---------------------------------------------
-- Precondition: invalid disallowed_by_ccs_entities_off parameter existed in PTU
-- Verification criteria: SDL considers PTU as invalid and does not merge PTU to LPT
-------------------------------------------------------------------------------
-- Define disallowed_by_ccs_entities_off contains 101 entities
local out_upper_bound = {}
out_upper_bound.disallowed_by_ccs_entities_off = {}
for i = 1, 101 do
	table.insert(out_upper_bound.disallowed_by_ccs_entities_off, 
	{
		entityType = i,
		entityID = i
	}
...
-- Define disallowed_by_ccs_entities_off contains 0 entity
local out_lower_bound = {
	disallowed_by_ccs_entities_off, 
	{
	}
}
-- Define disallowed_by_ccs_entities_off is invalid type (not array) 
local invalid_type = {
	disallowed_by_ccs_entities_off = {
		{
			10
...
-- Define disallowed_by_ccs_entities_off contains valid entity and invalid entity
...
for j=1, #test_data do
	...
	VerifyPTUFailedWithInvalidCcsOn(test_case_name, config.pathToSDL .. 'update_policy_table.json') 
