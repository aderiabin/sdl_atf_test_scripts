...
------------------------------------------- TC_1 ---------------------------------------------
-- Precondition: disallowed_by_ccs_entities_off contains 100 entityType and entityID parameter existed in PreloadedPT 
-- Verification criteria: 
-- 1. SDL considers PreloadedPT as valid
-- 2. Start successfully
-- 3. Saves valid entityType/entityID in entities table in LPT
local parent_item_entities_off = {"policy_table", "functional_groupings", "Location-1"}
local testing_value_entities_off = {}
testing_value_entities_off.disallowed_by_ccs_entities_off = {}
for i  = 1, 100 do
table.insert(testing_value_entities_off.disallowed_by_ccs_entities_off, 
				{
					entityType = i,
					entityID = i
				}
...
AddNewItemIntoPreloadedPt (test_case_name, parent_item_entities_off, testing_value_entities_off)
