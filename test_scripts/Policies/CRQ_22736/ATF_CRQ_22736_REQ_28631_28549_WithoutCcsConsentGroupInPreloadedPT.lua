--[[This script covers requirement APPLINK-28631, APPLINK-28549: [Policies] CCS: PreloadedPT without "ccs_consent_groups" struct
In case
...
-- SDL considers PreloadedPT file as valid and start successfully.
...
--RequirementID: APPLINK-28549
--Verification criteria: Verify ccs_consent_groups is not included in SnapShot file when it is not existed in PreloadedPT file
common_functions_for_crq_22736:checkExistedItemInSnapshot("ccs_consent_groups")
-------------------------------------- Postconditions ----------------------------------------
