...
--------------------------------------------------------------------------
-- Test 01.04:  
-- Description: disallowed_by_ccs_entities_on/off is omitted. Data consent is disallowed. HMI -> SDL: OnAppPermissionConsent(ccsStatus ON, function allowed)
...
--------------------------------------------------------------------------
-- Precondition:
--   HMI sends OnAppPermissionConsent with ccs status = ON and consented function = allowed
--------------------------------------------------------------------------
