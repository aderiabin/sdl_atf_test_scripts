...
--------------------------------------------------------------------------
-- Test 11.03:  
-- Description: Both disallowed_by_ccs_entities_off and disallowed_by_ccs_entities_on exist. 
--              HMI -> SDL: OnAppPermissionConsent(ccsStatus ON) match with some entities pairs. One of them make the group become disallowed. 
...
Test[TEST_NAME_ON .. "Precondition_HMI_sends_OnAppPermissionConsent"] = function(self)
  ...
  :Times(1)
  common_functions:DelayedExp(4000)
end
