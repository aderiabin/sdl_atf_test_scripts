...
--------------------------------------------------------------------------
-- Test 12.01:  
-- Description: disallowed_by_ccs_entities_off. HMI -> SDL: OnAppPermissionConsent(ccsStatus ON). Register new applications.
...
--------------------------------------------------------------------------
Test[TEST_NAME_ON .. "MainCheck_RPC_of_Application_3_Group001_is_disallowed"] = function(self)
