...
--------------------------------------------------------------------------
-- Test 04.02:  
-- Description: disallowed_by_ccs_entities_off exists. HMI -> SDL: OnAppPermissionConsent(ccsStatus ON, function disallowed)
...
--------------------------------------------------------------------------
-- Precondition:
--   HMI sends OnAppPermissionConsent with consented function = disallowed and ccs status = ON
--------------------------------------------------------------------------
