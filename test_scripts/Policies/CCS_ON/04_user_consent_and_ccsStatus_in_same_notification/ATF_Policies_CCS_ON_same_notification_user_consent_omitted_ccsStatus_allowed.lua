...
--------------------------------------------------------------------------
-- Test 04.02:  
-- Description: disallowed_by_ccs_entities_off exists. HMI -> SDL: OnAppPermissionConsent(ccsStatus ON, function allowed = nil)
...
--------------------------------------------------------------------------
-- Precondition:
--   HMI sends OnAppPermissionConsent with consented function allowed = nil and ccs status = ON
--------------------------------------------------------------------------
