...
local error_message = "SDL saved disallowed_by_external_consent_entities_off although existed invalid parameters in PreloadedPT."
...
for i=1, #invalid_entity_type_cases do
  ...
  local test_case_name = test_case_id .. "_disallowed_by_external_consent_entities_off.entityType_" .. invalid_entity_type_cases[i].description
  ...
  VerifySDLShutDownWithInvalidParamInPreloadedPT("_disallowed_by_external_consent_entities_off.entityType_".. invalid_entity_type_cases[i].description)
...
for i=1, #invalid_entity_id_cases do
  ...
  VerifySDLShutDownWithInvalidParamInPreloadedPT("_disallowed_by_external_consent_entities_off.entityId_" .. invalid_entity_id_cases[i].description)
  CheckPolicyTable("CheckPolicyTable_"..test_case_name, sql_query, error_message)
