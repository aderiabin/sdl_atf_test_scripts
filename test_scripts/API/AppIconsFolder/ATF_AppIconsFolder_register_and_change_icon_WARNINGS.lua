...
-- 13. HMI->SDL:SetAppIcon(success = true, resultCode = "WARNINGS")
...
function Test:SetAppIcon_action_bmp_WARNINGS()
  local cid = self.mobileSession:SendRPC("SetAppIcon",{
      syncFileName = "action.bmp"})
  EXPECT_HMICALL("UI.SetAppIcon",{
    syncFileName = {
  ...
  self.mobileSession:ExpectResponse(cid, {success = true, resultCode = "WARNINGS"})
end
