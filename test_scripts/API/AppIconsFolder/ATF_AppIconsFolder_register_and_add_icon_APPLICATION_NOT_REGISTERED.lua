...
-- 6. HMI->SDL:SetAppIcon(success = false, resultCode = "APPLICATION_NOT_REGISTERED")
...
function Test:SetAppIcon_APPLICATION_NOT_REGISTERED()
  ...
  EXPECT_HMICALL("UI.SetAppIcon",{
	...
	:Do(function(_,data)
    self.hmiConnection:SendError(data.id, data.method, 
        "APPLICATION_NOT_REGISTERED", "Error message.")
  end)
  self.mobileSession:ExpectResponse(cid, 
      {success = false, resultCode = "APPLICATION_NOT_REGISTERED", info = "Error message."})
end
