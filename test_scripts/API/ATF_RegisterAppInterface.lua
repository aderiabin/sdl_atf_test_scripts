...
--Description: DeviceInfo.hardware: lower bound = 0
...
--Description: DeviceInfo.firmwareRev: lower bound = 0
...
--Description: DeviceInfo.os: lower bound = 0
...
--Description: DeviceInfo.osVersion: lower bound = 0
...
--Description: DeviceInfo.carrier: lower bound = 0
...
function Test:RegisterAppInterface_ApplicationRegistere_Precondtion()
