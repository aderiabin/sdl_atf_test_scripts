...
The reason for closing the app to resumption is Ignition_off]]
--------------------------------------------------------------------------------
--[[APPLINK-26473:
In case
...
-- Case 1: Check Media app is resumed to FULL audible and Navi app to LIMITED audible. Value of MixingAudioSupported is true. Reason off is IGNITION_OFF
...
local full_test_case_name = "Case 1: IGNITION_OFF, IGNITION_ON, Media app is resumed to FULL, Navi app is resumed to LIMITED. MixingAudioSupported = true."
...
function_crq_26401:RestartSdlInitHmiConnectMobile(test_case_name)
...
local full_test_case_name = "Case 2: IGNITION_OFF, IGNITION_ON, Media app is resumed to FULL, Navi app is resumed to LIMITED. MixingAudioSupported = false."
...
local full_test_case_name = "Case 3: IGNITION_OFF, IGNITION_ON, Media app is resumed to LIMITED, Navi app is resumed to FULL. MixingAudioSupported = true."
...
function_crq_26401:RegisterTheSecondNaviApp(test_case_name)
function_crq_26401:ActivateTheSecondNaviApp(test_case_name)
-- 5. Close apps by IGNITION_OFF
function_crq_26401:IgnitionOff(test_case_name)
-- 6. Start SDL, Init HMI, Connect mobile
function_crq_26401:StopStartSdlInitHmiConnectMobile(test_case_name)
...
local full_test_case_name = "Case 4: IGNITION_OFF, IGNITION_ON, Media app is resumed to LIMITED, Navi app is resumed to FULL. MixingAudioSupported = false."
...
local full_test_case_name = "Case 5: IGNITION_OFF, IGNITION_ON, Media app is resumed to LIMITED, Navi app is resumed to LIMITED. MixingAudioSupported = true."
...
-- 7. Start SDL, Init HMI, Connect mobile
function_crq_26401:StopStartSdlInitHmiConnectMobile(test_case_name)
-- 8. Check media app is resumed to LIMITED
function_crq_26401:ResumeMediaApp("LIMITED")
-- 9. Check navi app is resumed to LIMITED
function_crq_26401:ResumeNaviApp("LIMITED")
-- 10. Check media app get Attenuated when navi app starts streaming. When navi app stops streaming, the media become Audible. These steps covers APPLINK-26503.
...
-- Case 6: Check Media app is resumed to LIMITED audible and Navi app to LIMITED audible. Value of MixingAudioSupported is false. Reason off is IGNITION_OFF
---------------------------------------------------------------------------------------------
local test_case_name = "Case_6"
local full_test_case_name = "Case 6: IGNITION_OFF, IGNITION_ON, Media app is resumed to LIMITED, Navi app is resumed to LIMITED. MixingAudioSupported = false."
