...
-- This function includes all checks for Paramter in Request
local function CheckParameterInRequest(test_name, request, param, mandatory)
  -- Param is missed
  if mandatory then
  ...
  -- Param value is empty
	Test[test_name .. "IsEmpty_INVALID_DATA"] = function(self)
		local testing_request = CloneTable(request)
		SetValueForParameter(testing_request, param, {})
    Verify_INVALID_DATA_Case(self, testing_request)
	end  
...
-- This function includes all checks for Integer Paramter in Request
local function CheckIntegerParameterInRequest(test_name, request, param, boundary, mandatory)
  -- Param is missed
  ...
  -- Param value is out of lower bound value
	Test[test_name .. "IsOutLowerBound_INVALID_DATA"] = function(self)
		local testing_request = CloneTable(request)
		SetValueForParameter(testing_request, param, boundary.lowerbound - 1)
    Verify_INVALID_DATA_Case(self, testing_request)
	end
  ...
  -- Param value is out of upper bound value
	Test[test_name .. "IsOutUpperBound_INVALID_DATA"] = function(self)
		local testing_request = CloneTable(request)
		SetValueForParameter(testing_request, param, boundary.upperbound + 1)
    Verify_INVALID_DATA_Case(self, testing_request)
	end
...
-- Main Check: Parameter timeStamp in request
CheckParameterInRequest("Check_SendLocation_timeStamp_", request, {"timeStamp"}, false)
...
-- Main Check: Integer Parameter millisecond in request
CheckIntegerParameterInRequest("Check_SendLocation_millisecond_", request, {"timeStamp", "millisecond"}, boundary, false)

boundary = {
  lowerbound = 0,
  upperbound = 60
}
-- Main Check: Integer Parameter second in request
CheckIntegerParameterInRequest("Check_SendLocation_second_", request, {"timeStamp", "second"}, boundary, false)

boundary = {
  lowerbound = 0,
  upperbound = 59
}
-- Main Check: Integer Parameter minute in request
CheckIntegerParameterInRequest("Check_SendLocation_minute_", request, {"timeStamp", "minute"}, boundary, false)

boundary = {
  lowerbound = 0,
  upperbound = 23
}
-- Main Check: Integer Parameter hour in request
CheckIntegerParameterInRequest("Check_SendLocation_hour_", request, {"timeStamp", "hour"}, boundary, false)

boundary = {
  lowerbound = 1,
  upperbound = 31
}
-- Main Check: Integer Parameter day in request
CheckIntegerParameterInRequest("Check_SendLocation_day_", request, {"timeStamp", "day"}, boundary, false)

boundary = {
  lowerbound = 1,
  upperbound = 12
}
-- Main Check: Integer Parameter month in request
CheckIntegerParameterInRequest("Check_SendLocation_month_", request, {"timeStamp", "month"}, boundary, false)

boundary = {
  lowerbound = 0,
  upperbound = 4095
}
-- Main Check: Integer Parameter year in request
CheckIntegerParameterInRequest("Check_SendLocation_year_", request, {"timeStamp", "year"}, boundary, false)

boundary = {
  lowerbound = -12,
  upperbound = 14
}
-- Main Check: Integer Parameter tz_hour in request
CheckIntegerParameterInRequest("Check_SendLocation_tz_hour_", request, {"timeStamp", "tz_hour"}, boundary, false)

boundary = {
  lowerbound = 0,
  upperbound = 59
}
-- Main Check: Integer Parameter tz_minute in request
CheckIntegerParameterInRequest("Check_SendLocation_tz_minute_", request, {"timeStamp", "tz_minute"}, boundary, false)
