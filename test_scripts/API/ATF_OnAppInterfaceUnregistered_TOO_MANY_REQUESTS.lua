...
function Test:send_Many_Request(app)
  ...
  :ValidIf(function(exp,data)
    ...
    function Test:APPLINK_18427_Case_AppIsFULL_RegisterAppAgain()
      ...
      EXPECT_RESPONSE(cid, { success = false, resultCode = "TOO_MANY_REQUESTS"})
    end
    ...
    function Test:Activate_MediaApp()
      local Input_AppId = self.applications[config.application2.registerAppInterfaceParams.appName]
    ...
    -- commonSteps:ActivationApp(2,"Activate_MediaApp")
    ...
    function Test:APPLINK_18427_Case_AppIsLIMITED_RegisterAppAgain()
      ...
      self.mobileSession1:ExpectResponse(cid, { success = false, resultCode = "TOO_MANY_REQUESTS"})
    end
    ...
    function Test:Activate_NonMediaApp()
      local Input_AppId = self.applications[config.application3.registerAppInterfaceParams.appName]
      local RequestId = self.hmiConnection:SendRequest("SDL.ActivateApp", { appID = Input_AppId})
      EXPECT_HMIRESPONSE(RequestId)
      :Do(function(_,data)
          if data.result.isSDLAllowed ~= true then
    ...
    function Test:APPLINK_18427_Case_BACKGROUND_RegisterAppAgain()
      ...
      self.mobileSession2:ExpectResponse(cid, { success = false, resultCode = "TOO_MANY_REQUESTS"})
    end
