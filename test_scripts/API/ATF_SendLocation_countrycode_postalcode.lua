...
-- This function includes all checks for String Paramter in Request
local function CheckStringParameterInRequest(test_name, request, param, boundary, mandatory)
  -- Param is missed
  if mandatory then  
  ...
  -- Param value is upper bound value
    ...
    local input_string = string.rep("a", boundary.upperbound)
		SetValueForParameter(testing_request, param, input_string)
    Verify_SUCCESS_Case(self, testing_request)
	end
  ...
  -- Param value contains white spaces only
	Test[test_name .. "ContainsWhiteSpacesOnly_INVALID_DATA"] = function(self)
		local testing_request = CloneTable(request)
		SetValueForParameter(testing_request, param, "   ")
    Verify_INVALID_DATA_Case(self, testing_request)
	end
  ...
  -- Param value contains special character: new line character
	Test[test_name .. "ContainsNewLineCharacter_INVALID_DATA"] = function(self)
		local testing_request = CloneTable(request)
		SetValueForParameter(testing_request, param, "a\nb")
    Verify_INVALID_DATA_Case(self, testing_request)
	end 

  -- Param value contains special character: Tab Character
	Test[test_name .. "ContainsTabCharacter_INVALID_DATA"] = function(self)
		local testing_request = CloneTable(request)
		SetValueForParameter(testing_request, param, "a\tb")
    Verify_INVALID_DATA_Case(self, testing_request)
	end 
...
CheckStringParameterInRequest("Check_SendLocation_countryCode_", 
  request, {"address", "countryCode"}, string_boundary, false)

-- Main Check: String parameter "postalCode"
CheckStringParameterInRequest("Check_SendLocation_postalCode_", 
  request, {"address", "postalCode"}, string_boundary, false)
