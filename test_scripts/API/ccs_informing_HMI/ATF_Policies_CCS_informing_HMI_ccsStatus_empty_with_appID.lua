--[[
This script purpose: Checking GetListOfPermissions response when HMI request with appID. HMI didn't send ccsStatus in OnAppPermissionConsent before.
--]]
------------------------------------------------------------------------------------------------------
...
----------------------------------------------------
-- Test-01.02:  
-- Description: HMI does NOT provide <ccsStatus> to SDL. HMI -> SDL: GetListOfPermissions with appID
-- Expected result:
...
--------------------------------------------------------------------------
-- Precondition:
--   HMI sends OnAppPermissionConsent ccsStatus array is empty
--------------------------------------------------------------------------
