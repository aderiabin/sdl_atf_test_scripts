...
elseif
  ...
  ----------------------------------------------------------------------------
  -- User functions
  local function extendedHMIStatusChecker(appNum, occurence, data)
    local report = {
      app = appNum,
      occurence = occurence,
      payload = data.payload
    }
    common_functions:PrintTable(report)
  end
                        ...
                        function Test:DeactivationAppFromFULLToBACKGROUND_LIMITEDToNOT_AUDIBLE_App_BACKGROUND_StaysWithoutChanges_DuringPhoneCall_RestoreLevelAfterPhoneCall()
                          ...
                          function Test:ChangingHMILevel_ByAcvivationNonMedia()
                            ...
                            :Do(function(_,data)
                                ...
                                self.mobileSession1:ExpectNotification("OnHMIStatus",
                                  {hmiLevel = "NONE", audioStreamingState = "NOT_AUDIBLE", systemContext = "MAIN"}, --1
                                  {hmiLevel = "FULL", audioStreamingState = "NOT_AUDIBLE", systemContext = "MAIN"}) --5
                                :Times(2)
                                :Do(function(exp,data)
                                    if exp.occurences == 1 then
                                      -- Openning VR menu
                                ...
                                if MediaApp or NaviComApp then
                                  EXPECT_NOTIFICATION("OnHMIStatus",
                                    {hmiLevel = "FULL", audioStreamingState = "NOT_AUDIBLE", systemContext = "MAIN"}, --2
                                    {hmiLevel = "FULL", audioStreamingState = "NOT_AUDIBLE", systemContext = "VRSESSION"}, --3
                                    {hmiLevel = "FULL", audioStreamingState = "AUDIBLE", systemContext = "VRSESSION"}, --4
                                    {hmiLevel = "FULL", audioStreamingState = "AUDIBLE", systemContext = "MAIN"}, --6
                                    expectedNotification) --7
                                  :Do(function(exp,data)
                                      if exp.occurences == 2 then
                                        ...
                                        self.hmiConnection:SendNotification("VR.Stopped",{})
                                        SendOnSystemContext(self, "MAIN", self.applications[config.application1.registerAppInterfaceParams.appName])
                          ...
                          function Test:ChangingHMILevel_ByAcvivationMedia()
                            ...
                            :Do(function(_,data)
                                ...
                                self.mobileSession1:ExpectNotification("OnHMIStatus",
                                  {hmiLevel = "NONE", audioStreamingState = "NOT_AUDIBLE", systemContext = "MAIN"}, --1
                                  {hmiLevel = "FULL", audioStreamingState = "NOT_AUDIBLE", systemContext = "MAIN"}, --4
                                  {hmiLevel = "FULL", audioStreamingState = "AUDIBLE", systemContext = "MAIN"}) --6
                                :Times(3)
                                :Do(function(exp,data)
                                    if exp.occurences == 1 then
                                ...
                                if MediaApp then
                                  EXPECT_NOTIFICATION("OnHMIStatus",
                                    {hmiLevel = "FULL", audioStreamingState = "NOT_AUDIBLE", systemContext = "MAIN"}, --2
                                    {hmiLevel = "FULL", audioStreamingState = "NOT_AUDIBLE", systemContext = "VRSESSION"}, --3
                                    {hmiLevel = "BACKGROUND", audioStreamingState = "NOT_AUDIBLE", systemContext = "VRSESSION"}, --5
                                    {hmiLevel = "BACKGROUND", audioStreamingState = "NOT_AUDIBLE", systemContext = "MAIN"}) --7
                                  :Do(function(exp,data)
                                      if exp.occurences == 2 then
                                        --activate app
                                        ActivationApp(self, self.applications[RAIParams.appName])
                          ...
                          if MediaApp or NaviComApp then
                            ...
                            function Test:DeactivationAppFromLimitedToBackground_ByAcvivationMedia()
                              ...
                              :Do(function(_,data)
                                  ...
                                  self.mobileSession1:ExpectNotification("OnHMIStatus",
                                    {hmiLevel = "NONE", audioStreamingState = "NOT_AUDIBLE", systemContext = "MAIN"}, --1
                                    {hmiLevel = "FULL", audioStreamingState = "NOT_AUDIBLE", systemContext = "MAIN"}, --3
                                    {hmiLevel = "FULL", audioStreamingState = "AUDIBLE", systemContext = "MAIN"}) --5
                                  :Times(3)
                                  :Do(function(exp,data)
                                      if exp.occurences == 1 then
                                        -- Openning VR menu
                                  ...
                                  if MediaApp then
                                    EXPECT_NOTIFICATION("OnHMIStatus",
                                      {hmiLevel = "LIMITED", audioStreamingState = "NOT_AUDIBLE", systemContext = "MAIN"}, --2
                                      {hmiLevel = "BACKGROUND", audioStreamingState = "NOT_AUDIBLE", systemContext = "MAIN"}) --4
                                    :Do(function(exp,data)
                                        if exp.occurences == 1 then
                                          --activate app
                                          ActivationApp(self, self.applications[RAIParams.appName])
                          ...
                          function Test:Precondition_RegisterActivateDeactivateApp()
                            ...
                            function Test:ActivateDeactivatedAppToFULL_ByVR()
                              ...
                              -- Openning VR menu
                              self.hmiConnection:SendNotification("VR.Started",{})
                              -- System context should not change to "VRSESSION" (APPLINK-16425)
                              SendOnSystemContext(self, "VRSESSION", self.applications[config.application1.registerAppInterfaceParams.appName])
                                                ...
                                                if MediaApp or NaviComApp then
                                                  ...
                                                  function Test:AudioStreaming_NOT_AUDIBLE_inLIMITED_MixingAudio_is_not_supported()
                                                    ...
                                                    :Do(function(_,data)
                                                      ...
                                                      --===================================================================================--
                                                      local function ChangeSystemContextForFullOnly()
                                                      ...
                                                      -- ChangeSystemContextForFullOnly()
