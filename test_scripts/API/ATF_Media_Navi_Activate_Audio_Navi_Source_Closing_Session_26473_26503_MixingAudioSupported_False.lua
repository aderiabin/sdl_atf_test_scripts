...
-- Case 1: Check Media app is resumed to FULL audible and Navi app to LIMITED audible. Value of MixingAudioSupported is false. Reason off is closing session
-- Case 2: Check Media app is resumed to LIMITED audible and Navi app to FULL audible. Value of MixingAudioSupported is false. Reason off is closing session
-- Case 3: Check Media app is resumed to LIMITED audible and Navi app to LIMITED audible. Value of MixingAudioSupported is false. Reason off is closing session
...
local full_test_case_name = "Case 1: Closing session and create session again, Media app is resumed to FULL, Navi app is resumed to LIMITED. MixingAudioSupported = false."
...
local full_test_case_name = "Case 2: Closing session and create session again, Media app is resumed to LIMITED, Navi app is resumed to FULL. MixingAudioSupported = false."
...
local full_test_case_name = "Case 3: Closing session and create session again, Media app is resumed to LIMITED, Navi app is resumed to LIMITED. MixingAudioSupported = false."
...
function_crq_26401:RegisterTheSecondNaviApp(test_case_name)
function_crq_26401:ActivateTheSecondNaviApp(test_case_name)
-- 5. Bring the media app to LIMITED
