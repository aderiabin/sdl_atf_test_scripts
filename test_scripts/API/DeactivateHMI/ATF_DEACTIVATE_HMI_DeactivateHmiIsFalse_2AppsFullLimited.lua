...
function Test:VerifyAppChangeToFULLorLIMITE_Incase_HmiLevelIsFULLorLIMITED_AndDeactiveHmiIsTrue()
  ...
  self[mobile_sessions[2]]:ExpectNotification("OnHMIStatus",{hmiLevel="FULL", audioStreamingState="AUDIBLE", systemContext = "MAIN"})
end
