-----------------------------------Test cases----------------------------------------
-- Checks that SDL postpones resumption of media app that was in LIMITED before unexpected disconnect
-- if SDL receives BasicCommunication.OnEventChanged("DEACTIVATE_HMI","isActive":true)
-- notification during "ApplicationResumingTimeout"
-- and receives BasicCommunication.OnEventChanged("DEACTIVATE_HMI","isActive":false)
...
-- -- -- HMI send BasicCommunication.OnEventChanged("eventName":"DEACTIVATE_HMI","isActive":false) to SDL. App is resumed to HMI level LIMITED
-- Postcondition
-- -- 1.UnregisterApp
-- -- 2.StopSDL
