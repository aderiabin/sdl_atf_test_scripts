...
-- 3. The request doesn't contain mandatory parameter "languageDesired" defined as
----- mandatory in mobile API for the current request

-- Steps:
-- 1. Mob -> SDL: "RegisterAppInterface" without "languageDesired"
...
--[[ Test ]]
function Test:TestStep_RegisterAppInterface_Mandatory_Missing_languageDesired()
