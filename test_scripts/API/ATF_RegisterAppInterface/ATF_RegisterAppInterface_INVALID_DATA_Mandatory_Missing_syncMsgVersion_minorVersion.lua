...
-- 3. The request doesn't contain mandatory parameter "minorVersion" of "syncMsgVersion"
---- structure defined as mandatory in mobile API for the current sturcture

-- Steps:
-- 1. Mob -> SDL: "RegisterAppInterface" without "minorVersion" of "syncMsgVersion"
...
--[[ Test ]]
function Test:TestStep_RegisterAppInterface_Mandatory_Missing_syncMsgVersion_minorVersion()
