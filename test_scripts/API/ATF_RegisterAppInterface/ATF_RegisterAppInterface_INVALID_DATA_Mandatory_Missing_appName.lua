...
-- 3. The request doesn't contain mandatory parameter "appName" defined as mandatory
----- in mobile API for the current request

-- Steps:
-- 1. Mob -> SDL: "RegisterAppInterface" without "appName"
...
--[[ Test ]]
function Test:TestStep_RegisterAppInterface_Mandatory_Missing_appName()
