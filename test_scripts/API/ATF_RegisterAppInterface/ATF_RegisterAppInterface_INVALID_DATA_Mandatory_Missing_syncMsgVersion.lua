...
-- 3. The request doesn't contain mandatory parameter "syncMsgVersion" defined as mandatory
----- in mobile API for the current request

-- Steps:
-- 1. Mob -> SDL: "RegisterAppInterface" without "syncMsgVersion"
...
--[[ Test ]]
function Test:TestStep_RegisterAppInterface_Mandatory_Missing_syncMsgVersion()
