...
-- 8. HMI responds with errorneous resultCode to RC.GetInteriorVehicleData(moduleType_2) request related to app1
-- SDL does:
-- 1. respond RegisterAppInterfaceResponse(success=true,result_code=RESUME_FAILED) to mobile application app1
-- 2. restore all data for app2 and respond RegisterAppInterfaceResponse(success=true,result_code=SUCCESS)
