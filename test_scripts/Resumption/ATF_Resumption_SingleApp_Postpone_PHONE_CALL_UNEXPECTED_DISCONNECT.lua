...
-- in case UNEXPECTED_DISCONNECT and PHONE_CALL is active BEFORE application is connected
-- 1.Preconditions:
...
---------------------------------------------------------------------------------------------
-- Requirement summary: Resumption for single application (hmiLevel=FULL) is postponed
-- in case UNEXPECTED_DISCONNECT and PHONE_CALL is active AFTER application is connected
-- 1.Preconditions:
-- -- 1.1. Application (NAVIGATION/COMMUNICATION/MEDIA/NON_MEDIA) is FULL
-- -- 1.2. Close session
-- 2.Steps:
