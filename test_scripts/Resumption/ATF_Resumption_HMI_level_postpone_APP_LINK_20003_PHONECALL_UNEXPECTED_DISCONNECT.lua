...
local function RegisterAppThenIgnitionOff(self, prefix, level)
	...
	commonSteps:ActivationApp(_,tostring(prefix).."_Activation_App")			
	 ...
	 -- Test[tostring(prefix).."_SUSPEND"] = function(self)		
		-- SUSPEND(self, level)
	 -- end
...
local function CloseSession_Start4Session(self, appType)
	...
	Test["Close_Session_3"] = function(self) 
	...
	Test["Close_Session_4"] = function(self) 
	...
	Test["StartSession_1"] = function(self)
		userPrint(35, "================= Start Session ==================")
		self.mobileSession = mobile_session.MobileSession(self,self.mobileConnection,appId1)
	end		
	Test["StartSession_2"] = function(self)		
		self.mobileSession2 = mobile_session.MobileSession(self,self.mobileConnection,appId2)
	end	
	Test["StartSession_3"] = function(self)		
		self.mobileSession3 = mobile_session.MobileSession(self,self.mobileConnection,appId3)
	end	
	Test["StartSession_4"] = function(self)		
		self.mobileSession4 = mobile_session.MobileSession(self,self.mobileConnection,appId4)
	end	
end
...
function Test:resumptionSuccessWhenPhoneCallEnded4Apps_FullL_Limited_Limited_Background()
	--Phone call ended
	self.hmiConnection:SendNotification("BasicCommunication.OnEventChanged",{isActive= false, eventName="PHONE_CALL"})
	notificationState.PhoneCall = false
...
function Test:resumptionSuccessWhenPhoneCallEnded4Apps_Full_Limited_Limited_Limited()
	--Phone call ended
	self.hmiConnection:SendNotification("BasicCommunication.OnEventChanged",{isActive= false, eventName="PHONE_CALL"})
	notificationState.PhoneCall = false
...
local function PhoneCall_IsActive_And_Register4Apps(pos)
	if (pos==1) then		
		Test["Phone_Call_Is_Active_Before_Register_App"] = function(self)				
			userPrint(35, "=================== PHONE_CALL is active ===================")
			self:phoneCallIsActive()
		end
	end		
	-------App1
	Test["StartService_App1"] = function(self)	
		userPrint(35, "=================== Register Apps ===================")
		self.mobileSession:StartService(7)
	end
	Test:registerTheFirstApp(test_data[4].app)
...
------------------------------------------------------------------------------------------------------------------------------------
-- Case: Single App (FULL) - Unexpected Disconnect: Phone call is active BEFORE app is connected and waiting for resume
-- Step1: Change App Type
-- Step2: Register/Activate app
-- Step3: Close/Start sesstion
-- Step4: PHONE_CALL.True
-- Step5: Active app
-- Step6: Incase App is Non MEDIA, resumpt success without PHONE_CALL end
-- Step7: Send isActive Invalid value (Empty, Wrong size, Is Missed)
-- Step8: Resumption postpone
-- Step9: Send IsActive Valid value (isActive=false)
-- Step10: Resumption success
------------------------------------------------------------------------------------------------------------------------------------
local function Resumption_HMIlevelFULL_PhoneCallTrue_Before_UNEXPECTED_DISCONNECT()		
	for i =4, #test_data do
		commonFunctions:newTestCasesGroup("Single App (FULL) - Unexpected Disconnect: Phone call is active BEFORE app is connected and waiting for resume: " ..test_data[i].app)
		
		Test["Change_App_Type_To_" .. test_data[i].app] = function(self)
		...
		commonSteps:RegisterAppInterface(test_data[i].app.."_Register_App")			
		commonSteps:ActivationApp(_,test_data[i].app.."_Activation_App")
		
		CloseSession_StartSession(self,test_data[i].app)
				
		if test_data[i].app=="NON MEDIA" then
			Test[test_data[i].app .."_SingleApp_HMIlevelFULL_PhoneCallActive_Resumption_WithoutCallEnd"] = function(self)
				self:noneMedia_ResumptionSuccessWithoutPhoneCallEnded(1)  -- 1: phone call is active before app reconnected
			end
			Test["Postcondition-PhoneCall_End"]=function(self)
				self.hmiConnection:SendNotification("BasicCommunication.OnEventChanged",{isActive= false, eventName="PHONE_CALL"})
				notificationState.PhoneCall = false
			end
		else 
				
			Test[test_data[i].app .."_Phone_Call_Is_Active_Before_Register_App"] = function(self)
				self:phoneCallIsActiveAndRegisterApp(1) --1:phone call is active before app reconnected
			end
					
			-- 3 cases: resumption unsuccesfull - isActive Invalid
			Test:resumptionUnsuccessWhenPhoneCallWithIsActiveInvalid(test_data[i].app,hmi_level_FULL)
			
			-- case: resumption successfully - isActive Valid
			Test[test_data[i].app .."_Resumption_SingleApp_HMIlevelFULL_PhoneCallIsActive_Before_AppIsConnected_Valid"] = function(self)
					self:resumptionSuccessWhenPhoneCallEnded(hmi_level_FULL) 
			end
		end
	end	
end
Resumption_HMIlevelFULL_PhoneCallTrue_Before_UNEXPECTED_DISCONNECT()

------------------------------------------------------------------------------------------------------------------------------------
-- Case: Single App (LIMITED) - Unexpected Disconnect: Phone call is active BEFORE app is connected and waiting for resume
-- Step1: Change App Type
...
-- Step10: Resumption success
------------------------------------------------------------------------------------------------------------------------------------
local function Resumption_HMIlevelLIMITED_PhoneCallTrue_Before_UNEXPECTED_DISCONNECT()		
	for i =1, #test_data-1 do
		commonFunctions:newTestCasesGroup("Single App (LIMITED) - Unexpected Disconnect: Phone call is active BEFORE app is connected and waiting for resume:  " ..test_data[i].app)
		Test["Change_App_Type_To_" .. test_data[i].app] = function(self)
			userPrint(35, "================= Precondition ==================")
			self:change_App_Params(1,test_data[i].appType,test_data[i].isMedia)			
		end	
		...
		commonSteps:ChangeHMIToLimited(test_data[i].app.."_Change_App_To_Limited")
		...
		-- 3 cases: resumption unsuccesfull - isActive Invalid
		Test:resumptionUnsuccessWhenPhoneCallWithIsActiveInvalid(test_data[i].app,hmi_level_LIMITED)
		
		-- case: resumption successfully - isActive Valid
		Test[test_data[i].app .."_Resumption_SingleApp_HMIlevelLIMITED_PhoneCallIsActive_Before_AppIsConnected_Valid"] = function(self)
				self:resumptionSuccessWhenPhoneCallEnded(hmi_level_LIMITED) 
		end
	end	
end
Resumption_HMIlevelLIMITED_PhoneCallTrue_Before_UNEXPECTED_DISCONNECT()

------------------------------------------------------------------------------------------------------------------------------------
-- Case: Single App (FULL) - Unexpected Disconnect: Phone call is active AFTER app is connected and waiting for resume
-- Step1: Change App Type
-- Step2: Register/Activate app
-- Step3: Close/Start sesstion
-- Step4: PHONE_CALL.True
...
-- Step10: Resumption success
------------------------------------------------------------------------------------------------------------------------------------
local function Resumption_HMIlevelFULL_PhoneCallTrue_After_UNEXPECTED_DISCONNECT()		
	for i =1, #test_data do
		commonFunctions:newTestCasesGroup("Single App (FULL) - Unexpected Disconnect: Phone call is active AFTER app is connected and waiting for resume:  " ..test_data[i].app)
		...
		if test_data[i].app=="NON MEDIA" then
			Test[test_data[i].app .."_SingleApp_HMIlevelFULL_PhoneCallActive_Resumption_WithoutCallEnd"] = function(self)
				self:noneMedia_ResumptionSuccessWithoutPhoneCallEnded(2)  -- 2: phone call is active after app reconnected
			end
			Test["Postcondition-PhoneCall_End"]=function(self)
				self.hmiConnection:SendNotification("BasicCommunication.OnEventChanged",{isActive= false, eventName="PHONE_CALL"})
				notificationState.PhoneCall = false
			...
			Test[test_data[i].app .."_Phone_Call_Is_Active_Before_Register_App"] = function(self)
				self:phoneCallIsActiveAndRegisterApp(2) --2:phone call is active after app reconnected
			end
			...
			-- case: resumption successfully - isActive Valid 
			Test[test_data[i].app .."_Resumption_SingleApp_HMIlevelFULL_PhoneCallIsActive_After_AppIsConnected_Valid"] = function(self)
					self:resumptionSuccessWhenPhoneCallEnded(hmi_level_FULL) 
			end
		end
	end	
end
Resumption_HMIlevelFULL_PhoneCallTrue_After_UNEXPECTED_DISCONNECT()

------------------------------------------------------------------------------------------------------------------------------------
-- Case: Single App (LIMITED) - Unexpected Disconnect: Phone call is active AFTER app is connected and waiting for resume
-- Step1: Change App Type
-- Step2: Register/Activate app/ChangeHMIToLimited
-- Step3: Close/Start sesstion
-- Step4: PHONE_CALL.True
...
local function Resumption_HMIlevelLIMITED_PhoneCallTrue_After_UNEXPECTED_DISCONNECT()		
	for i =1, #test_data-1 do
		commonFunctions:newTestCasesGroup("Single App (LIMITED) - Unexpected Disconnect: Phone call is active AFTER app is connected and waiting for resume:  " ..test_data[i].app)
...
Resumption_HMIlevelLIMITED_PhoneCallTrue_After_UNEXPECTED_DISCONNECT()
...
--///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////--
------------------------------------------------------------------------------------------------------------------------------------
-- Case: Multiple Apps (FULL,LIMITED,LIMITED,BACKGROUND) - Unexpected Disconnect: Phone call is active AFTER apps is connected and waiting for resume
-- Step1: Unregister previous Apps
-- Step2: Register/Activate apps
-- Step3: Close/Start sesstion
-- Step4: PHONE_CALL.True
-- Step5: Active apps
-- Step6: Send isActive Invalid value (Empty, Wrong size, Is Missed)
-- Step7: Resumption postpone
-- Step8: Send IsActive Valid value (isActive=false)
-- Step9: Resumption success
------------------------------------------------------------------------------------------------------------------------------------

local function Resumption_MultiApps_FULL_LIMITED_LIMITED_BACKGOUND_PhoneCallIsActive_Before_AppIsConnected_UNEXPECTED_DISCONNECT()		
	commonFunctions:newTestCasesGroup("Multiple Apps (FULL,LIMITED,LIMITED,BACKGROUND) - Unexpected Disconnect: Phone call is active AFTER apps is connected and waiting for resume: ")
	...
	Test["Resumption_MultiApp_HMIlevelFULL_PhoneCallIsActive_Before_AppIsConnected_IsActiveValid"] = function(self)
			self:resumptionSuccessWhenPhoneCallEnded4Apps_FullL_Limited_Limited_Background() 
	end
end
Resumption_MultiApps_FULL_LIMITED_LIMITED_BACKGOUND_PhoneCallIsActive_Before_AppIsConnected_UNEXPECTED_DISCONNECT()
...
local function Resumption_MultiApps_FULL_LIMITED_LIMITED_BACKGOUND_PhoneCallIsActive_After_AppIsConnected_UNEXPECTED_DISCONNECT()		
	commonFunctions:newTestCasesGroup("Multiple Apps (FULL,LIMITED,LIMITED,BACKGROUND) - Unexpected Disconnect: Phone call is active AFTER apps is connected and waiting for resume: ")
	...
	--case: resumption start successfully 
	Test["Resumption_MultiApp_HMIlevelFULL_PhoneCallIsActive_After_AppIsConnected_isActiveValid"] = function(self)
			self:resumptionSuccessWhenPhoneCallEnded4Apps_FullL_Limited_Limited_Background() 
	end
end
Resumption_MultiApps_FULL_LIMITED_LIMITED_BACKGOUND_PhoneCallIsActive_After_AppIsConnected_UNEXPECTED_DISCONNECT()
...
--///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////--
------------------------------------------------------------------------------------------------------------------------------------
-- Case: Multiple Apps (FULL,LIMITED,LIMITED,LIMITED) - Unexpected Disconnect: Phone call is active BEFORE apps is connected and waiting for resume
-- Step1: Unregister previous Apps
-- Step2: Register/Activate apps
-- Step3: Close/Start sesstion
-- Step4: PHONE_CALL.True
...
-- Step9: Resumption success
------------------------------------------------------------------------------------------------------------------------------------
local function Resumption_MultiApps_FULL_LIMITED_LIMITED_LIMITED_PhoneCallIsActive_Before_AppIsConnected_UNEXPECTED_DISCONNECT()		
	commonFunctions:newTestCasesGroup("Multiple Apps (FULL,LIMITED,LIMITED,LIMITED) - Unexpected Disconnect: Phone call is active BEFORE apps is connected and waiting for resume: ")
	...
	--case: resumption start successfully 
	Test["Resumption_MultiApp_HMIlevelFULL_PhoneCallIsActive_Before_AppIsConnected_UNEXPECTED_DISCONNECT"] = function(self)
			self:resumptionSuccessWhenPhoneCallEnded4Apps_Full_Limited_Limited_Limited() 
	end
end
Resumption_MultiApps_FULL_LIMITED_LIMITED_LIMITED_PhoneCallIsActive_Before_AppIsConnected_UNEXPECTED_DISCONNECT()

------------------------------------------------------------------------------------------------------------------------------------
-- Case: Multiple Apps (FULL,LIMITED,LIMITED,LIMITED) - Unexpected Disconnect: Phone call is active AFTER apps is connected and waiting for resume
-- Step1: Unregister previous Apps
-- Step2: Register/Activate apps
-- Step3: Close/Start sesstion
-- Step4: Active apps
-- Step5: PHONE_CALL.True
-- Step6: Send isActive Invalid value (Empty, Wrong size, Is Missed)
-- Step7: Resumption postpone
-- Step8: Send IsActive Valid value (isActive=false)
-- Step9: Resumption success
------------------------------------------------------------------------------------------------------------------------------------
local function Resumption_MultiApps_FULL_LIMITED_LIMITED_LIMITED_PhoneCallIsActive_After_AppIsConnected_UNEXPECTED_DISCONNECT()		
	commonFunctions:newTestCasesGroup("Multiple Apps (FULL,LIMITED,LIMITED,LIMITED) - Unexpected Disconnect: Phone call is active AFTER apps is connected and waiting for resume: ")
	...
	--case: resumption start successfully 
	Test["Resumption_MultiApp_HMIlevelFULL_PhoneCallIsActive_After_AppIsConnected_UNEXPECTED_DISCONNECT"] = function(self)
			self:resumptionSuccessWhenPhoneCallEnded4Apps_Full_Limited_Limited_Limited() 
	end
end
Resumption_MultiApps_FULL_LIMITED_LIMITED_LIMITED_PhoneCallIsActive_After_AppIsConnected_UNEXPECTED_DISCONNECT()
