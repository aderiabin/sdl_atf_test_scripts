...
---------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------------------------------------
-- Case 1-14: HMI Level resumption for NAVIGATION/MEDIA/COMMUNICATION/MEDIA app is postponed in case UNEXPECTED_DISCONNECT and VR is active before/after app is connected
  ...
  for i = 1, #RESUMED_HMI_LEVEL do
    for j = 1, #apps do
      if (RESUMED_HMI_LEVEL[i] ~= "LIMITED") or (apps[j].appName ~= "NON_MEDIA") then
        common_functions:newTestCasesGroup("TC_" .. tostring(tc_number) .. " \"" .. RESUMED_HMI_LEVEL[i] .. "\" resumption for \"" .. apps[j].appName .. "\" app is postponed in case UNEXPECTED_DISCONNECT and VR is active " .. (START_EVENT_BEFORE_AFTER_REGISTER_APP[x] == true and 'BEFORE' or 'AFTER') .. " app is connected")
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- Case 15-16: HMI Level resumption for multiple apps(FULL/LIMITED/LIMITED/BACKGROUND) are postponed in case UNEXPECTED_DISCONNECT and VR is active before/after apps are connected
-- NO. AppType HMIStatus VR.Start before registering app (true-before; false-after)
----------------------------------------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
for x = 1, #START_EVENT_BEFORE_AFTER_REGISTER_APP do
  common_functions:newTestCasesGroup("Multiple apps (Full-Limited-Limited-Background) are postponed in case UNEXPECTED_DISCONNECT and VR is active " .. (START_EVENT_BEFORE_AFTER_REGISTER_APP[x] == true and 'BEFORE' or 'AFTER') .. " apps are connected")
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- Case 17-18: HMI Level resumption for multiple apps(FULL/LIMITED/LIMITED/LIMITED) are postponed in case UNEXPECTED_DISCONNECT and VR is active before/after apps are connected
-- NO. AppType HMIStatus VR.Start before registering app (true-before; false-after)
----------------------------------------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
for x = 1, #START_EVENT_BEFORE_AFTER_REGISTER_APP do
  common_functions:newTestCasesGroup("Multiple apps (Full-Limited-Limited-Limited) are postponed in case UNEXPECTED_DISCONNECT and VR is active " .. (START_EVENT_BEFORE_AFTER_REGISTER_APP[x] == true and 'BEFORE' or 'AFTER') .. " apps are connected")
