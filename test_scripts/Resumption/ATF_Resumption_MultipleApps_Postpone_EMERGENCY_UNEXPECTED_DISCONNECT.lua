...
---------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- Requirement summary: Resumption for multiple applications FULL/LIMITED/LIMITED/BACKGROUND) is postponed in case UNEXPECTED_DISCONNECT and Emergency is active BEFORE applications are connected
-- 1.Preconditions:
...
local function CheckMultipleAppsFullLimitedLimitedBackgroundArePostponedWhenEmergencyIsStartedBeforeRegisteredApp()
  ...
  " in case UNEXPECTED_DISCONNECT and Emergency is active BEFORE apps are connected")
  -- Precondition
  for i = 1, #apps do
...
---------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- Requirement summary: Resumption for multiple applications FULL/LIMITED/LIMITED/BACKGROUND) is postponed in case UNEXPECTED_DISCONNECT and Emergency is active AFTER applications are connected
-- 1.Preconditions:
-- -- 1.1. Applications (NAVIGATION/COMMUNICATION/MEDIA/NON_MEDIA) are (FULL/LIMITED/LIMITED/BACKGROUND)
-- -- 1.2. Close session
-- 2.Steps:
...
---------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- Requirement summary: Resumption for multiple applications FULL/LIMITED/LIMITED/LIMITED) is postponed in case UNEXPECTED_DISCONNECT and Emergency is active BEFORE applications are connected
-- 1.Preconditions:
...
---------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- Requirement summary: Resumption for multiple applications FULL/LIMITED/LIMITED/LIMITED) is postponed in case UNEXPECTED_DISCONNECT and Emergency is active AFTER applications are connected
-- 1.Preconditions:
-- -- 1.1. Applications (NAVIGATION/COMMUNICATION/MEDIA/NON_MEDIA) are (FULL/LIMITED/LIMITED/LIMITED)
-- -- 1.2. Close session
-- 2.Steps:
