...
---------------------------------------------------------------------------------------------
-----------------------------------------I TEST BLOCK----------------------------------------
--------------------------------------CommonRequestCheck: Check that app correctly registers with "NL-BE" language. "NL-BE" language was got by GetLanguage" in connecttest_"NL-BE"-----------------------------------
---------------------------------------------------------------------------------------------
	...
	--TODO: Test is checked CRQ APPLINK-13745 - additional languages "NL-BE", "EL-GR", "HU-HU", "FI-FI", "SK-SK". For new ATF version need to create test to check all languages in one script
				...
				function Test:RegisterAppInterface_NL_BE() 
