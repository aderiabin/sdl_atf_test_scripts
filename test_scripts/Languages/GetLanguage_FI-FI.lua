...
---------------------------------------------------------------------------------------------
-----------------------------------------I TEST BLOCK----------------------------------------
--------------------------------------CommonRequestCheck: Check that app correctly registers with "NL-BE" language. "FI-FI" language was got by GetLanguage" in connecttest_"FI-FI"-----------------------------------
---------------------------------------------------------------------------------------------
	...
	--TODO: Test is checked CRQ APPLINK-13745 - additional languages "NL-BE", "EL-GR", "HU-HU", "FI-FI", "SK-SK". For new ATF version need to create test to check all languages in one script
				...
				function Test:RegisterAppInterface_FI_FI() 
