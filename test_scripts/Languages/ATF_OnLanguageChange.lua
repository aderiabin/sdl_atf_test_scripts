...
--Wrong type values
SendOnLanguageChange("UI.OnLanguageChange", 100, "SendUIOnLanguageChange_language_IsWrongType", false)
SendOnLanguageChange("VR.OnLanguageChange", 200, "SendVROnLanguageChange_language_IsWrongType", false)
SendOnLanguageChange("TTS.OnLanguageChange", 300, "SendTTSOnLanguageChange_language_IsWrongType", false)
...
local function SpecialResponseChecks()
  ...
  function Test:UIOnLanguageChange_FakeParameterIsFromAnotherAPI()
    print()
    --hmi side: sending OnLanguageChange notification
  ...
  function Test:VROnLanguageChange_FakeParameterIsFromAnotherAPI()
  ...
  function Test:TTSOnLanguageChange_FakeParameterIsFromAnotherAPI()
