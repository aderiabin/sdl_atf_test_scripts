...
function appIconsFolderCommon.makeAppIconsFolderFull(AppIconsFolder, availableSize)
  ...
  local i = 1
  while sizeToFull > availableSize do
    os.execute("sleep 2")
...
function appIconsFolderCommon.registerApplication(RAIParameters, test)
