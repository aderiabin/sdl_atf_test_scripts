---------------------------------------------------------------------------------------------
-- Requirement summary:
-- [APPLINK-10335] Merging rules for "functional_groupings" section - exists in LocalPT and does not exist in PreloadedPT
--
-- Description:
-- Check of merging rules for "functional_groupings" section in case when exists in LocalPT and does not exist in PreloadedPT
...
-- and "functional_group_name" section with 2 groups (the same that were in precondition)
--
-- Expected result:
