...
local fs_common_functions = require('user_modules/common_functions')
...
function Test:TestStep_ValidateResult()
  ...
  :ValidIf(function(_, _)
      ...
      local removed_json_items = {"preloaded_date"}
      fs_common_functions:RemoveItemsFromJsonFile(policy_file_path .. "/sdl_snapshot.json", parent_item, removed_json_items)
