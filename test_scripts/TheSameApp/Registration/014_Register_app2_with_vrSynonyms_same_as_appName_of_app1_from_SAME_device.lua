...
--    SDL sends OnAppRegistered(application.appName = "first_app", vrSysnonyms = "vrApp") notification to HMI
...
--    SDL does not send OnAppRegistered(application.appName = "second_app", vrSysnonyms = "Test Application") notification to HMI from Mobile
---------------------------------------------------------------------------------------------------
