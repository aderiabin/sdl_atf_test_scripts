...
-- Description:
-- Two mobile applications with the same appNames, same appIDs and same ttsName are registering from different
...
-- 2)Mobile №2 sends RegisterAppInterface request (with all mandatories) with appID= 0001, appName = "Test Application"
--    and ttsName = "TtsName" to SDL
--   Check:
