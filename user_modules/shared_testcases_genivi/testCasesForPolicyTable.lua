...
--How to use:
--1. local testCasesForPolicyTable = require('user_modules/shared_testcases_genivi/testCasesForPolicyTable')
...
local PolicyTableTemplate2 = "user_modules/shared_testcases_genivi/PolicyTables/DefaultPolicyTableWith_group1_2.json"

--New policy table
local PolicyTable = "user_modules/shared_testcases_genivi/PolicyTables/TestingPolicyTable.json"
...
function testCasesForPolicyTable:createPolicyTableWithoutAPI(APIName)
  ...
  PolicyTable = "user_modules/shared_testcases_genivi/PolicyTables/TestingPolicyTable192837465.json"
