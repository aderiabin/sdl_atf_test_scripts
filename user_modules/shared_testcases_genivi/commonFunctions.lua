...
--How to use:
  --1. local commonFunctions = require('user_modules/shared_testcases_genivi/commonFunctions')
...
--cleanup environment for clean test run
function commonFunctions:cleanup_environment( )
  ...
  if common_functions:IsFileExist("/tmp/fs/mp/images/ivsu_cache/sdl_snapshot.json") then
    os.execute("rm -rf " .. "/tmp/fs/mp/images/ivsu_cache/sdl_snapshot.json")
  end
