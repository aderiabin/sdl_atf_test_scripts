...
--------------------------------------------------------------------------
function CCS_ON_OFF_common_functions:PreconditonSteps(mobile_connection_name, mobile_session_name_1, mobile_session_name_2)
  -- delete sdl_snapshot
...
-- params: no
--------------------------------------------------------------------------
function CCS_ON_OFF_common_functions:ConvertPreloadedToJson()
...
--------------------------------------------------------------------------
function CCS_ON_OFF_common_functions:CreateJsonFileForPTU(input_data, json_file_path, json_file_path_debug)
...
--------------------------------------------------------------------------
function CCS_ON_OFF_common_functions:UpdatePolicy(self, json_file_path, input_app_id)
...
--------------------------------------------------------------------------
function CCS_ON_OFF_common_functions:GetGroupId(data, group_name)
...
--------------------------------------------------------------------------
function CCS_ON_OFF_common_functions:QueryPolicyTable(policy_file, sql_query)
